...
\begin{tikzpicture}
  \begin{axis}
    [ ybar,
      ...
      xtick=data,
      point meta=explicit symbolic,
      title=Accuracy (Macro-averaged)
    ]
    \addplot table [x=n,y=bfb,meta=k] {\amacro};
    \addlegendentry{bfb};
    \addplot table [x=n,y=bps,meta=k] {\amacro};
    \addlegendentry{bps};
    \addplot table [x=n,y=bnh,meta=k] {\amacro};
    \addlegendentry{bnh};
    \addplot table [x=n,y=wfb,meta=k] {\amacro};
    \addlegendentry{wfb};
    \addplot table [x=n,y=wps,meta=k] {\amacro};
    \addlegendentry{wps};
    \addplot table [x=n,y=wnh,meta=k] {\amacro};
    \addlegendentry{wnh};
  \end{axis}
\end{tikzpicture}
